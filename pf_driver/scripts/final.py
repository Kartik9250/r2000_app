...
class lidar_plot:
	...
	def plotting_scan(self):
		...
		self.num_d = {'Distance': self.range_arr}		# Dict shows the sales of flavor of each group 
		self.fig,self.ax = plt.subplots()

		self.annot = self.ax.annotate("", xy=(0,0), xytext=(10,10), textcoords='offset points', bbox=dict(boxstyle='round', fc='w'))
		self.annot.set_visible(False)

		self.fig.canvas.mpl_connect("motion_notify_event", self.hover)


	def update_annot(ind, self):
		"""
